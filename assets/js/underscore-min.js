!(function(n, r) {
	...
	mr([ 'pop', 'push', 'reverse', 'shift', 'sort', 'splice', 'unshift' ], function(n) {
		...
		tn.prototype[n] = function() {
			var t = this._wrapped;
			return null != t && (r.apply(t, arguments), ('shift' !== n && 'splice' !== n) || 0 !== t.length || delete t[0]), Qr(this, t);
		};
	}),
	...
	var Yr = Xr({
		...
		template: function(n, r, t) {
			...
			var e,
				u = RegExp([ (r.escape || Gn).source, (r.interpolate || Gn).source, (r.evaluate || Gn).source ].join('|') + '|$', 'g'),
				o = 0,
				i = "__p+='";
		...
		last: function(n, r, t) {
			return null == n || n.length < 1
				? null == r || t ? void 0 : []
				: null == r || t ? n[n.length - 1] : Lr(n, Math.max(0, n.length - r));
		},
		rest: Lr,
		tail: Lr,
		drop: Lr,
